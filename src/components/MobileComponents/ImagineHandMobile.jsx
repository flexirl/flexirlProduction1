  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-w-[402px] min-h-[400px] mx-auto bg-white">
      ...
      <div className="flex justify-center mt-6 w-full">
        <button onClick={onOpenCta} className="flex items-center justify-center w-[114px] h-[21px] cursor-pointer relative rounded-sm focus:outline-none focus:ring-2 focus:ring-[#1f392c] focus:ring-opacity-50" aria-label="Let's Connect - Contact us to start your project">
