    ...
    <div className={`fixed inset-0 z-50 ${isOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}>
      ...
      >
        <div className="relative h-full overflow-hidden flex flex-col">
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 w-[64px] h-[64px] bg-[#ef4b6e] rounded-full flex items-center justify-center text-white font-semibold z-30"
          ...
          <div className="overflow-auto flex-1 px-8 sm:px-10 pt-28 pb-32">
            <div className="flex items-start justify-between">
              <h2 className="font-syne-bold text-white text-4xl sm:text-5xl md:text-5xl leading-[42px] sm:leading-[49px] tracking-[1.6px] max-w-[60%]">
                To Say
                <br />
                hello
              </h2>
              ...
              <div className="hidden sm:flex flex-col text-right text-[#ffffffb3] text-xs leading-tight ml-4">
                <a href="tel:+918002315259" className="hover:underline">+91-8002315259</a>
                <a href="mailto:info@flexirl.com" className="hover:underline mt-1">info@flexirl.com</a>
            ...
            <div className="sm:hidden mt-4 text-xs text-[#ffffffb3]">
              <div><a href="tel:+918002315259" className="hover:underline">+91-8002315259</a></div>
              <div className="mt-1"><a href="mailto:info@flexirl.com" className="hover:underline">info@flexirl.com</a></div>
            </div>
            ...
            >
              <div>
                <label className="text-[#ffffff85] text-[14px] tracking-[1.2px] block mb-2">Name</label>
                <input
                  value={name}
              ...
              <div>
                <label className="text-[#ffffff85] text-[14px] tracking-[1.2px] block mb-2">Email</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label className="text-[#ffffff85] text-[14px] tracking-[1.2px] block mb-2">Message</label>
                <textarea
                  rows={5}
                  value={message}
