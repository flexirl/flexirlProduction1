  ...
  const teamMembers = [
    {
      ...
      image: f1,
      bgColor: "#F59E0B",
      description: "Creative leader shaping brand narratives and visual direction",
      instagram: "https://instagram.com/ayushya",
      linkedin: "https://linkedin.com/in/ayushya",
      email: "ayushya@flexirl.com"
    },
    {
      id: 2,
      name: "Balmukund",
      ...
      image: f2,
      bgColor: "#06B6D4",
      description: "Driving product and growth through technology and marketing",
      instagram: "https://instagram.com/balmukund",
      linkedin: "https://linkedin.com/in/balmukund",
      email: "balmukund@flexirl.com"
    },
    {
      id: 3,
      name: "Anubhav",
      ...
      linkedin: "https://linkedin.com/in/anubhav",
      email: "anubhav@flexirl.com"
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            <div className="max-w-3xl">
              ...
              <FlexirlLineReveal align="left" lines={[
                { text: 'Our Team', size: 'small' },
                { text: 'Meet the Founders', size: 'large', hasRedDot: true },
              ]} />

              <p className="text-base text-gray-600 leading-relaxed mt-4">
                We're a small team of creators who care deeply about design and product.
              </p>
            </div>
          </div>
                    ...
                    <div className="p-8 bg-gray-50">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <a href={member.instagram} target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-white shadow hover:scale-105 transition">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5z" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7z" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="18" cy="6" r="0.5" fill="#111827"/></svg>
                          </a>
                          <a href={member.linkedin} target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full bg-white shadow hover:scale-105 transition">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16 8a6 6 0 016 6v6h-4v-6a2 2 0 00-4 0v6h-4v-12h4v2" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 9h4v12H2z" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="4" cy="4" r="1.5" fill="#111827"/></svg>
                          </a>
                        </div>

                        <a href={`mailto:${member.email}`} className="text-sm text-gray-700 hover:underline">
                          {member.email}
                        </a>
                      </div>
                    </div>
