      ...
      <div className="hidden lg:block w-full relative">
        ...
        >
          ...
          <div className="relative max-w-[1200px] mx-auto px-8 lg:px-12 xl:px-16 py-24 lg:py-28 xl:py-36 flex flex-col items-center justify-center text-center min-h-[580px]">
            <h1 className="reveal-up relative w-full max-w-[980px] [font-family:'Inter_28pt-Black',Helvetica] font-black text-transparent text-5xl lg:text-6xl xl:text-7xl tracking-[4px] lg:tracking-[6.6px] leading-[56px] lg:leading-[72px] xl:leading-[80px]">
              <span className="text-[#1f392c] tracking-[3.2px]">Spark your </span>
              <span className="text-[#1f392ce3] tracking-[3.2px]">brand&#39;s <br /></span>
              <span className="text-[#1f392c] tracking-[3.2px]">
                <span className="imaginative-ring hidden lg:inline-block align-middle">
                  ...
                  <svg className="ring-svg" viewBox="0 0 100 50" preserveAspectRatio="none" aria-hidden="true">
                    <ellipse cx="50" cy="25" rx="48" ry="22" pathLength="100" />
                  </svg>
                </span>
                <span className="inline lg:hidden">imaginative</span> flair <br />
              </span>
              <span className="text-[#1f392ce6] tracking-[3.2px]">with</span>
              <span className="text-[#1f392c] tracking-[3.2px]"> us</span>
            </h1>

            <p className="reveal-up delay-1 relative mt-6 w-full max-w-[820px] [font-family:'Syne-Regular',Helvetica] font-normal text-[#1f392c] text-xl lg:text-[26px] text-center leading-8 lg:leading-8">
